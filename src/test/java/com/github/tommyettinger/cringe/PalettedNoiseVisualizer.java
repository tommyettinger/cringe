 ...
 */
public class PalettedNoiseVisualizer extends ApplicationAdapter {
    ...
    Array<Color> palette = Colors.getColors().values().toArray();
    int noiseIndex = 2;
    ...
    public void create() {
        ...
        palette.removeValue(Color.CLEAR, true);
        palette.shuffle();
        ...
        gif.palette = new QualityPalette(gray256);
...
//                }
            ...
            case 1:
                for (int x = 0; x < width; x++) {
                    for (int y = 0; y < height; y++) {
                        ...
                        renderer.color(palette.get((int)(bright * (palette.size - 0.05f))));
                        renderer.vertex(x, y, 0);
                    }
                }
                break;
    ...
    public static void main(String[] arg) {
        ...
        new Lwjgl3Application(new PalettedNoiseVisualizer(), config);
    }
}
