 ...
 */
public class PerklinNoise extends RawNoise {
    public static final PerklinNoise instance = new PerklinNoise();
...
//    }
    ...
    public PerklinNoise(final int seed) {
        this.seed = seed;
    }

    public PerklinNoise(PerklinNoise other) {
     ...
     */
    @Override
    public PerklinNoise copy() {
        return new PerklinNoise(this.seed);
    }
     ...
     */
    @Override
    public PerklinNoise stringDeserialize(String data) {
        seed = MathSupport.intFromDec(data, 1, data.indexOf('`', 1));
        return this;
    }

    public static PerklinNoise recreateFromString(String data) {
        return new PerklinNoise(MathSupport.intFromDec(data, 1, data.indexOf('`', 1)));
    }
    ...
    public boolean equals(Object o) {
        ...
        PerklinNoise that = (PerklinNoise) o;
