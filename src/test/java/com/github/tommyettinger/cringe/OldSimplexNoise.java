 ...
 */
public class OldSimplexNoise extends RawNoise {

    public int seed;
    public static final OldSimplexNoise instance = new OldSimplexNoise();

    public OldSimplexNoise() {
        seed = 0x1337BEEF;
    }

    public OldSimplexNoise(int seed)
    {
        this.seed = seed;
    }
    ...
    public OldSimplexNoise stringDeserialize(String data) {
        seed = (MathSupport.intFromDec(data, 1, data.length() - 1));
        return this;
    }

    public static OldSimplexNoise recreateFromString(String data) {
        return new OldSimplexNoise(MathSupport.intFromDec(data, 1, data.length() - 1));
    }
    ...
    @Override
    public OldSimplexNoise copy() {
        return new OldSimplexNoise(seed);
    }

    @Override
    public String toString() {
        return "OldSimplexNoise{seed=" + seed + "}";
    }
    ...
    public boolean equals(Object o) {
        ...
        OldSimplexNoise that = (OldSimplexNoise) o;
