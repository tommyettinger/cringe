 ...
 * support 5D or 6D noise. This is very similar to {@link OpenSimplex2FastNoise}, but has less noticeably-separate "spots" or
 * "surflets" of similar results, and tends to smooth results into continuous gradients. It is faster than
 * OpenSimplex2SmoothNoise, though.
 * <br>
 * OpenSimplex2.java was originally by KdotJPG, who released it into the public domain.
 * <a href="https://github.com/KdotJPG/OpenSimplex2/blob/45cc32d5bf09ec89732ea108669417b6cad4546d/LICENSE">Original license</a>.
 */
public class OpenSimplex2SmoothNoise extends RawNoise {
    public int seed;

    public OpenSimplex2SmoothNoise() {
        seed = 0x31337;
    }

    public OpenSimplex2SmoothNoise(int seed) {
        this.seed = seed;
    }
     ...
     */
    @Override
    public OpenSimplex2SmoothNoise copy() {
        return new OpenSimplex2SmoothNoise(seed);
    }
    ...
    public OpenSimplex2SmoothNoise stringDeserialize(String data) {
    ...
    public static OpenSimplex2SmoothNoise recreateFromString(String data) {
        return new OpenSimplex2SmoothNoise(MathSupport.intFromDec(data, 1, data.length() - 1));
    }

    @Override
    public String getTag() {
        return "OpenSimplex2SmoothNoise";
    }
    ...
    public boolean equals(Object o) {
        ...
        OpenSimplex2SmoothNoise that = (OpenSimplex2SmoothNoise) o;
