 ...
 */
public class OpenSimplex2FastNoise extends RawNoise {
    public int seed;

    public OpenSimplex2FastNoise() {
        seed = 0x31337;
    }
    ...
    /**
     * Returns true if this generator can be seeded with {@link #setSeed(int)} and retrieved with {@link #getSeed()},
     * which this can be.
     *
     * @return true, because {@link #setSeed(int)} and {@link #getSeed()} are supported
     */
    @Override
     ...
     */
    @Override
    public OpenSimplex2FastNoise copy() {
        return new OpenSimplex2FastNoise(seed);
    }
    ...
    public OpenSimplex2FastNoise stringDeserialize(String data) {
    ...
    public static OpenSimplex2FastNoise recreateFromString(String data) {
        return new OpenSimplex2FastNoise(MathSupport.intFromDec(data, 1, data.length() - 1));
    }

    @Override
    public String getTag() {
        return "OpenSimplex2FastNoise";
    }
     ...
     */
    public static float noise2(int seed, float x, float y) {
     ...
     */
    public static float noise2_ImproveX(int seed, float x, float y) {
     ...
     */
    private static float noise2_UnskewedBase(int seed, float xs, float ys) {
     ...
     */
    public static float noise3_ImproveXY(int seed, float x, float y, float z) {
     ...
     */
    public static float noise3_ImproveXZ(int seed, float x, float y, float z) {
     ...
     */
    public static float noise3_Fallback(int seed, float x, float y, float z) {
     ...
     */
    private static float noise3_UnrotatedBase(int seed, float xr, float yr, float zr) {
     ...
     */
    public static float noise4_ImproveXYZ_ImproveXY(int seed, float x, float y, float z, float w) {
     ...
     */
    public static float noise4_ImproveXYZ_ImproveXZ(int seed, float x, float y, float z, float w) {
     ...
     */
    public static float noise4_ImproveXYZ(int seed, float x, float y, float z, float w) {
     ...
     */
    public static float noise4_ImproveXY_ImproveZW(int seed, float x, float y, float z, float w) {
     ...
     */
    public static float noise4_Fallback(int seed, float x, float y, float z, float w) {
     ...
     */
    private static float noise4_UnskewedBase(int seed, float xs, float ys, float zs, float ws) {
    ...
    private static float grad(int seed, long xsvp, long ysvp, float dx, float dy) {
    ...
    private static float grad(int seed, long xrvp, long yrvp, long zrvp, float dx, float dy, float dz) {
    ...
    private static float grad(int seed, long xsvp, long ysvp, long zsvp, long wsvp, float dx, float dy, float dz, float dw) {
    ...
    public boolean equals(Object o) {
        ...
        OpenSimplex2FastNoise that = (OpenSimplex2FastNoise) o;
