 ...
 */
public class LoamNoise extends RawNoise {
    ...
    public static final LoamNoise instance = new LoamNoise();

    public LoamNoise() {
        this(1234567890);
    }

    public LoamNoise(int seed)
    {
        this.seed = seed;
    }
    ...
    public float getNoiseWithSeed(float x, float y, int seed) {
        ...
        xin = p2;
        yin = p0;
        final float b = valueNoise(xin, yin, seed ^ 0x2B53AEEB);
        xin = p0;
        yin = p1;
        final float c = valueNoise(xin, yin, seed ^ 0xEDB6A8EF);
    ...
    public float getNoiseWithSeed(float x, float y, float z, int seed) {
        ...
        yin = p2;
        zin = p3;
        final float b = valueNoise(xin, yin, zin, seed ^ 0x2B53AEEB);
        xin = p0;
        yin = p1;
        zin = p3;
        final float c = valueNoise(xin, yin, zin, seed ^ 0xEDB6A8EF);
        xin = p0;
        yin = p1;
        zin = p2;
        final float d = valueNoise(xin, yin, zin, seed ^ 0x51D00B65);
    ...
    /**
     * Gets 4D loam noise using {@link #getSeed()}.
     *
     * @param x x coordinate
     * @param y y coordinate
     * @param z z coordinate
    ...
    public float getNoiseWithSeed(float x, float y, float z, float w, int seed) {
        ...
        zin = p3;
        win = p4;
        final float b = valueNoise(xin, yin, zin, win, seed ^ 0x2B53AEEB);
        xin = p0;
        yin = p1;
        zin = p3;
        win = p4;
        final float c = valueNoise(xin, yin, zin, win, seed ^ 0xEDB6A8EF);
        xin = p0;
        yin = p1;
        zin = p2;
        win = p4;
        final float d = valueNoise(xin, yin, zin, win, seed ^ 0x51D00B65);
        xin = p0;
        yin = p1;
        zin = p2;
        win = p3;
        final float e = valueNoise(xin, yin, zin, win, seed ^ 0x6F88983F);
    ...
    public float getNoiseWithSeed(float x, float y, float z, float w, float u, int seed) {
        ...
        win = p4;
        uin = p5;
        final float b = valueNoise(xin, yin, zin, win, uin, seed ^ 0x2B53AEEB);
        xin = p0;
        yin = p1;
        zin = p3;
        win = p4;
        uin = p5;
        final float c = valueNoise(xin, yin, zin, win, uin, seed ^ 0xEDB6A8EF);
        xin = p0;
        yin = p1;
        zin = p2;
        win = p4;
        uin = p5;
        final float d = valueNoise(xin, yin, zin, win, uin, seed ^ 0x51D00B65);
        xin = p0;
        yin = p1;
        zin = p2;
        win = p3;
        uin = p5;
        final float e = valueNoise(xin, yin, zin, win, uin, seed ^ 0x6F88983F);
        xin = p0;
        yin = p1;
        zin = p2;
        win = p3;
        uin = p4;
        final float f = valueNoise(xin, yin, zin, win, uin, seed ^ 0xB7D03F7B);
    ...
    public float getNoiseWithSeed(float x, float y, float z, float w, float u, float v, int seed) {
        ...
        uin = p5;
        vin = p3;
        final float b = valueNoise(xin, yin, zin, win, uin, vin, seed ^ 0x2B53AEEB);
        xin = p1;
        yin = p2;
        zin = p3;
        win = p4;
        uin = p6;
        vin = p5;
        final float c = valueNoise(xin, yin, zin, win, uin, vin, seed ^ 0xEDB6A8EF);
        xin = p6;
        yin = p0;
        zin = p2;
        win = p5;
        uin = p4;
        vin = p1;
        final float d = valueNoise(xin, yin, zin, win, uin, vin, seed ^ 0x51D00B65);
        xin = p2;
        yin = p1;
        zin = p5;
        win = p0;
        uin = p3;
        vin = p6;
        final float e = valueNoise(xin, yin, zin, win, uin, vin, seed ^ 0x6F88983F);
        xin = p0;
        yin = p4;
        zin = p6;
        win = p3;
        uin = p1;
        vin = p2;
        final float f = valueNoise(xin, yin, zin, win, uin, vin, seed ^ 0xB7D03F7B);
        xin = p5;
        yin = p1;
        zin = p2;
        win = p3;
        uin = p4;
        vin = p0;
        final float g = valueNoise(xin, yin, zin, win, uin, vin, seed ^ 0x0B04AB1B);
     ...
     *
     * @return the minimum supported dimension, which is 1 inclusive
     */
    @Override
    ...
    @Override
    public LoamNoise stringDeserialize(String data) {
        setSeed(MathSupport.intFromDec(data, 1, data.length() - 1));
        return this;
    }

    public static LoamNoise recreateFromString(String data) {
        return new LoamNoise(MathSupport.intFromDec(data, 1, data.length() - 1));
    }
    ...
    @Override
    public LoamNoise copy() {
        return new LoamNoise(this.seed);
    }

    @Override
    public String toString() {
        return "LoamNoise{seed=" + seed + "}";
    }
